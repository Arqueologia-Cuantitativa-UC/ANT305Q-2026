# Clase 1. Introducción a la Arqueología Cuantitativa. Conceptos Básicos.
...
# Crear una matriz a partir de una secuencia de 1 al 12. Podemos definir el número de filas (nrow) y columnas (ncol)
...
# 6. Data Frames. ---------------------------------------------------------
# El Data Frame es la estructura más importante en arqueología. A diferencia de la matriz, un Data Frame permite que cada columna tenga un tipo de dato diferente (por ejemplo: una columna con nombres de sitios, otra con tipos de cerámica, etc.). Es lo más parecido a una tabla de Excel.
