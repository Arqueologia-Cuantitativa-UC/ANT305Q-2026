...
La **hipótesis nula (H₀)** asume que las variables son independientes, es decir, que no existe asociación entre ellas. Si el valor p es menor a 0.05, rechazamos la hipótesis nula y concluimos que sí existe una asociación significativa.
